...
static MaterialUniformValue::Struct buildDefaultValues(const std::vector<asset::ShaderBlockMember>& members);
...
MaterialUniformValue::Struct buildDefaultValues(const std::vector<asset::ShaderBlockMember>& members) {
